...
def banner():
    #os.system('clear')
    print(f"""
\033[1;30m  ____     _    _____ _     ____  _     
\033[1;30m /  _ \   / |  /  __// \ |\/  _ \/ \  /|
\033[1;30m | | \|   | |  |  \  | | //| / \|| |\ ||
\033[1;30m | |_/|/\_| |  |  /_ | \// | |-||| | \||
\033[1;30m \____/\____/  \____\\__/  \_/ \|\_/  \|
                                       

  \033[91;1m  ╔════════════════════════════════════════╗
   {H} ║{P}[{H}•{P}] Author    :{warna} Evan-VAW                 {N}{H}║
  {H}  ║{P}[{H}•{P}] Facebook  : {H}Evan Chowdhury              {N}{H}║
    {H}║{P}[{H}•{P}] Whatsapp  : {M}+8801877721475          {N}{H}║
  {H}  ║{P}[{H}•{P}] Github    : {K}github.com/cyberEvan-31{N}    {H}  ║
...
def mainx():
    ...
    if mahin in ["1","01"]:
     ...
     os.system("xdg-openhttps://www.facebook.com/profile.php?id=100086216861789 ");mainx()
    elif mahin in ["0","00"]:
     print(f'{gen}{RED}Exited {H}FB-KING {P}Terminal ');os.system("https://www.facebook.com/profile.php?id=100086216861789");time.sleep(3);os.system('xdg-open https://www.facebook.com/groups/fb.king.cyber/?ref=share'');exit()
    else:
     print(f"{dot}{M}Don't Select Wrong Options ");os.system("https://www.facebook.com/profile.php?id=100086216861789'');mainx()
def mainx2():
    os.system("clear")
    banner()
